    ...
    <head>
      <meta charset="UTF-8">
      <title>Continue as Customer</title>
    ...
    <span></span>
      <div class="login-html">
        ...
        <div class="login-form">
          ...
          <form class="sign-up-htm" action="mysql/signup.php" method="POST">
            <div class="group">
            ...
            <div class="group">
              ...
              <input id="phoneNumber" name="phoneNumber" type="text" class="input" pattern="[0-9+|]{6,25}" required>
            </div>
            <div class="group">
              <label for="pass" class="label">Password</label>
